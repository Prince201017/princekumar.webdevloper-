  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[50vh] sm:h-[60vh] bg-black text-white">
        ...
        <img
          src="/eloura-men-fashion-model-in-sleek-modern-clo.jpg"
          alt="Men's Collection"
          className="w-full h-full object-cover"
        />
        <div className="absolute inset-0 z-20 flex items-center">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <h1 className="text-3xl sm:text-4xl lg:text-6xl font-bold mb-4 tracking-tight">MEN</h1>
            <p className="text-base sm:text-lg lg:text-xl mb-8 max-w-md">
              Explore our contemporary menswear collection
            </p>
            <Link href="/">
              <Button
                variant="outline"
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <p className="text-sm text-muted-foreground">
              {filteredAndSortedProducts.length} of {menProducts.length} Products
            </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-4 sm:gap-6 lg:gap-8">
            {filteredAndSortedProducts.map((product) => (
              <Link key={product.id} href={`/products/men/${product.id}`} className="group relative block">
