...
export default function UnderwearProductDetailsPage() {
  ...
  const product = {
    name: "Modern Cotton Boxer Brief",
    price: 28,
    originalPrice: 35,
    rating: 4.6,
    reviews: 156,
    description:
      "Ultra-comfortable boxer briefs crafted from our signature Modern Cotton blend. Features a contoured pouch, no-roll waistband, and tag-free design for all-day comfort. The perfect combination of style and functionality.",
    care: "Machine wash warm with like colors. Do not bleach. Tumble dry medium. Do not iron. Do not dry clean.",
    shipping:
      "Free shipping on orders over $50. Standard delivery 3-5 business days. Express delivery available for next-day shipping.",
    sizes: {
      USA: ["S", "M", "L", "XL", "XXL"],
      Asian: ["M", "L", "XL", "XXL", "XXXL"],
    },
    images: [
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <DetailHeader backUrl="/products/underwear" backLabel="Back to Underwear" />
              ...
              <div className="p-8 lg:p-12">
                <div className="space-y-8">
                  ...
                  <div className="flex gap-4">
                    <Button
                      className="bg-green-400 hover:bg-green-500 text-black font-medium py-4 text-lg rounded-lg transition-colors"
