...
export default function ProductDetailsPage() {
  ...
  const product = {
    ...
    reviews: 128,
    description:
      "Crafted from our signature Modern Cotton fabric, this bralette offers all-day comfort with a minimalist design. Features removable padding and adjustable straps for the perfect fit. Made with premium materials for lasting quality and style.",
    care: "Machine wash cold with like colors. Do not bleach. Tumble dry low. Do not iron. Do not dry clean.",
    shipping: "Free shipping on orders over $50. Standard delivery 3-5 business days. Express delivery available.",
    sizes: {
      USA: ["XS", "S", "M", "L", "XL", "XXL"],
      Asian: ["S", "M", "L", "XL", "XXL", "XXXL"],
    },
    images: [
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <DetailHeader backUrl="/products/women" backLabel="Back to Women" />
